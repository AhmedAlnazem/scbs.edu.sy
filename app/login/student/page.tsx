      ...
      <header className={styles.newnavbar}>
        <div className={styles.navInner}>
          ...
          <div className={styles.brandBlock}>
            ...
            <span className={styles.brandSubtitle}>بوابة دخول الطلاب</span>
          </div>
        ...
        <div className={styles.heroShell}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.description}>
              هذه البوابة مخصصة لحسابات الطلاب فقط. إذا كان حسابك تابعًا لمعلم أو إدارة،
              استخدم بوابة المعلمين والإدارة.
            </p>
          </div>
          ...
          <div className={styles.formCard}>
            <div className={styles.loginModeSwitch}>
              ...
              <Link className={styles.loginModeLink} href="/login/teacher">
